...
import Mywelcom from '../controls/Mywelcom';
const Welcome = () => {
      ...
      <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between px-6 py-16 gap-10">
        <div className="flex-1 text-center md:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            ...
            <Link
              to="/resister"
              className="border border-orange-500 text-orange-500 px-6 py-3 rounded-lg font-medium hover:bg-orange-100 transition"
            >
              Sign Up
            </Link>
          </div>
        ...
        <div className="flex-1">
          <img
            ...
            alt="Hero"
            className="w-full rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:w-fit"
          />
        </div>
      </div>
            ...
            {Mywelcom.map((product) => (
              ...
              >
                <img
                  src={product.image}
                  alt={product.id}
                  className="h-48 w-full object-cover hover:scale-105 transition-all duration-300"
                />
                <div className="p-4">
